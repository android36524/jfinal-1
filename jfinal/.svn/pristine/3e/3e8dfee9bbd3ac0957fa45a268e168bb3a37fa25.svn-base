					...
					<div class="row">
		                ...
		                <div class="tab-content">
                            ...
                            <div class="panel-body">
			                	<div class="col-md-2">
			                		<h3>进货笔数：<strong>${into.get('num')}</strong></h3>
								</div>
			                	<div class="col-md-2">
			                		<h3>进货总额：<strong style="color: red;">￥${into.get('price')}</strong></h3>
								</div>
			                	<div class="col-md-6">
			                		<h3>进货额最高的商品：<span>${maxP.get('pName')}</span></h3>
			                		<h3>进货最多的商品：<span>${most.get('pName')}</span></h3>
			                		<h3>供货额最高的供应商：<span>${total.get('sName')}</span></h3>
								</div>
                            </div>
						</div>
		                <div class="tab-content">
